  ...
  return (
    <div className="relative w-screen h-screen flex justify-center items-center">
      ...
      <div className="z-10 relative flex justify-center items-center flex-col gap-7">
        ...
        <button onClick={() => router.push('/orion/narrative')} className="text-xl drop-shadow-lg logo text-darkerGreen rounded-full bg-lightyellow px-8 py-0.5">Start</button>
      </div>
    </div>
  )
}