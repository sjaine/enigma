...
function Map() {
    ...
    const destinationCoordinates = [-79.6992433597845, 43.4691171371867]; // [longitude, latitude]
  ...
  return (
    <>
      ...
      <div className="fixed bg-light card text-brown border-2 border-brown rounded-3xl flex justify-center items-center flex-col p-5 gap-[30px]">
        ...
        <div>
            <img src="/rainbow.jpg" alt="rainbow bridge" className="questImg mb-5" />
            <p className="text-xl text-brown mt-2 subhead">📍 Location: Rainbow Bridge</p>
                <p className="text-xl text-brown mt-3 subhead">📝 Task: Head to the Rainbow Bridge. There, seek the next task.</p>
        </div>
